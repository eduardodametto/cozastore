...
public class Produto 
{
    ...
    [Column(TypeName = "decimal(2,3)")] //99.999,999
    public decimal Peso { get; set; }

    [StringLength(10, ErrorMessage = "O Material deve possuir no máximo 10 caracteres")]
    public string Material { get; set; }

    [Display(Name = "Dimensão")]
    [StringLength(10, ErrorMessage = "A Dimensão deve possuir no máximo 10 caracteres")]
